...
class X3D_Dataset(Dataset):
    def __init__(self,
                 ...
                 img_size=224,
                 transform=None,
                 detach_input_tensor = False):
        self._downsample = 4
        self.num_classes = 2  
        self.detach_input_tensor = detach_input_tensor          
        if is_train:
            self.pathhhhh = os.path.join("/home/ubuntu/train.csv")#path train 
            
        else:
            self.pathhhhh = os.path.join("/home/ubuntu/val.csv")#path validation
...
#             f.readline()
            for line in f:
                ...
                result_dict[key][key1].append(row[6])
    ...
    def class_to_list(l,numclasses):
        ...
        for i in l_entiers:
            liste0[i]=1
        # print("**************l_entiers   ",l_entiers)
        # print("**************l_enliste0   ",liste0)
        return liste0
...
#         annotations= self.class_to_list(labels,self.num_classes)
        ...
        uniform_temporal_subsample = UniformTemporalSubsample(num_samples=13)
...
if __name__ == '__main__':
    ...
    training_loader  = torch.utils.data.DataLoader(dataset_train,drop_last=False,
                                         pin_memory=True, batch_size=2, num_workers=1,
    ...
    def train_one_epoch(epoch_index, tb_writer):
        ...
        for i, data in enumerate(training_loader):
            ...
            del inputs, labels, outputs, loss, accuracy
...
################################################################
    ...
    #             print(vlabels[0]["labels"])
        ...
        if avg_vloss < best_vloss:
            ...
            poid_path = 'poid_{}_{}.pth'.format("amine", epoch_number)
